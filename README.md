...
1. For extra security, create a dedicated FreeBSD non-wheel user account for Steam. Switch to it. In case of getting X server errors, start your X session from the new account. [optional]
